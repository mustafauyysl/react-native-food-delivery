...
class OrderScreen extends Component {
  ...
  calculateTotalPrice = () => {
    let finalPrice = 0;
    this.props.cart.map((x) => (finalPrice += x.quantity * x.product.price));
    return finalPrice;
  };
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <RadioContainer title="Adres" list={address} />
        <RadioContainer title="Ödeme Yöntemi" list={paymentMethod} />
